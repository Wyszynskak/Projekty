#' Wskaznik sredniej liczby polubien na posta na fanpage'u kandydata
#'
#' Funkcja \code{wybory_wsk_fb_liczba_like_post} zlicza srednia liczbe polubien na posta na fanpage'u kandydata.
#'
#' @usage
#' \code{wybory_wsk_fb_liczba_like_post(okres,wzor,sciezka_odczyt=getwd())}
#'
...
#'
#' @details
#' Sposob obliczania wskaznika "sredniej ilosci" polubien postow na fanpage'u:
#'
#' Dla danego okresu zlicza srednia arytmetyczna liczby polubien postow
...
#'
#' @examples
#' wybory_wsk_fb_liczba_like_post("dzien","2015-04-14")
#' wybory_wsk_fb_liczba_like_post("tydzien","2015-14")
#' wybory_wsk_fb_liczba_like_post("miesiac","2015-04")
#'
#' @author Piotr Smuda
#'

wybory_wsk_fb_liczba_like_post<-function(okres,wzor,sciezka_odczyt=getwd()){
